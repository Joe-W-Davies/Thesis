...
the full design energy of 6.5\,TeV per beam is expected to be achieved in future, beginning in 2021.

The key components of the LHC are its 1,232 main dipole magnets, 392 main quadrupole magnets and 16 radiofrequency (RF) cavities.
...
of 2.2\,cm. %radius of cylinder containing 90% of average deposition; two contain 95% therefore.
...
To reconstruct the shower energy, the photodetectors amplify the scintillation light to produce around 4,500 photoeletrons per GeV.
...
which totals between 5.8 and and 10.6 interaction lengths ($\lambda_I$) depending on $\eta$ \footnote{An 
interaction length is defined as the length over which 
a particle has a probability $e^{-1}$ of decaying.}.
...
%TODO check parameters of the CMS HCAL, following Equation~\ref{eq:resolution}
