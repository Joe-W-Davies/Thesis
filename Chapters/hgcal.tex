...
Further detail on th 2D clustering and multiclustering procedures are given in Ref.~\cite{ClusteringConf}.
...
Three categories were chosen in order to faciliate comparison with the Run~2 results presented 
...
The HGCAL is a key part of the CMS detector upgrade planned as part of the HL-LHC program, 
