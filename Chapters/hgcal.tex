...
The corresponding mean pileup per bunch crossing will be 140; however an additional 50\% beyond the nominal value is allowed for in the HL-LHC design, 
...
%TODO add footnote defining these things here
...
%TODO intrinsic performance means...
Energy deposits in a radius of \SI{26}{mm} around a single unconverted photon are summed to estimate the energy resolution, which is shown in Figure \ref{fig:hgcal_PhotonReso}. %TODO justtify 26mm value
...
%this is achieved due to the fine granularity
...
representing a substantial improvement relative to Run 2, where the endcap resolution is significantly worse than the barrel. %TODO quantify this

%TODO fix formatting of these two plots
\begin{figure}[h!]
  \centering
...
\begin{enumerate}
  ...
  whose value is chosen to be similar to the Moli\`ere radius. %TODO add footnote with definition
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption[Illustration of the imagine algorithm used for HGCAL layer clustering.] %TODO improve this caption
  {
...
%TODO define ROC curve - cross check with categorisation and objects chapters
...
%TODO add and comment on beam test plots
\begin{figure}[h!]
  \centering
  %\includegraphics[width=0.7\textwidth]{Figures/HGCAL/BeamTest.png}
