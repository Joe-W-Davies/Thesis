...
This has the effect of wideing the 2NLL curve and thereby increasing the overall uncertainty
...
with a model constructed for each particle level stage 1 cross sectio bin 
...
to accurately model the shape for a given combinatoin of stage 1 bin, 
...
\item \textit{QCD scale uncertainty}: 
  ...
  and varying both in the same direction simulataneously.
...
\item \textit{Uncertainty on the SM ggH production}: 
  ...
  typically having the greatest associated uncertianty.
