...
This pattern of symmetry breaking depends on the choice of representation for the Higgs field;
...
In contrast if the fit parameter is only the observed cross section $\sigma$, 
...
whilst permitting advanced analysis techniques.
