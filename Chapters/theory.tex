...
\end{equation}
where for the doublets for the quarks and leptons to have charges which differ by one unit of $e$ 
in charge $g\sin{\theta_W} = e$. 
...
Substituting this into the Lagrangian yields the mass terms
\begin{equation}
...
The Higgs mechanism is therefore able to explain exactly the observed mass structure 
of the gauge bosons.
...
announced the discover of a new particle resembling the Higgs boson~\cite{ATLASdiscovery,CMSdiscovery}.
To achieve this, several Higgs boson production modes and decay channels were analysed.
...
and the methods used to discriminate between them is given in Chapter~5.%\ref{chap:categorisation}.
