...
the $p$-value with respect to the SM hypothesis is approximately XX\%. %TODO revise how this is done
...
In the seven-parameter fit, the magnitiudes of the correlations are generally small.
...
\begin{figure}[hptb]
  ...
  \caption[Oberved correlations in a seven-parameter fit in the STXS framework.]
  {
...
\begin{figure}[hptb]
  ...
  \caption[Oberved correlations in a thirteen-parameter fit in the STXS framework.]
  {
...
have been presented.
At stage 0, two parameters corresping to ggH and electroweak qqH production are measured, 
...
\centering
  ...
  \caption[Results summary of seven-parameter fit in the STXS framework.]
  {
    The results of a seven-parameter fit in the STXS framework. 
    The ggH 1J and 2J BSM bins are grouped together in the fit; 
    the remaining five ggH bins with two or more jets are also grouped. 
...
\centering
  ...
  \caption[Results summary of thirteen-parameter fit in the STXS framework.]
  {
    The results of a thirteen-parameter fit in the STXS framework. 
    The two VBF-like ggH bins are grouped to form one parameter, 
    as are the VBF BSM-like, VH-like and Rest bins.
