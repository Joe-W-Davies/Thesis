...
where ...
%definition of POIs
%don't forget to explain the constraint terms and how they affect the yields
...
\NLL = 
\end{equation}
%description of how the signal and background functions are fitted to the observed data
%e.g. some reference to RooFit and Minuit here?
...
In the following section, the observed diphoton mass distributions 
